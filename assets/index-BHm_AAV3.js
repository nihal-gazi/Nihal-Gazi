    ...
    <div style="position: relative; z-index: 10; width: 100%; max-width: 1200px; margin-top: -4vw;">
      ...
      <div class="beyond-flex-container" style="display: flex; flex-wrap: wrap; gap: 4rem; justify-content: space-between; align-items: flex-start;">
        ...
        <div class="font-body" style="flex: 1 1 400px; font-size: 1rem; color: #cccccc; line-height: 1.7;">
          ...
          Global AI development is is an active struggle against algorithmic ceilings and not just about parameter scaling. Ranked #21 globally on the Hugging Face TCTF Leaderboard for individual open-source contributions (Dec 2025), I actively push the frontiers of edge computing, model compression, and accessible artificial intelligence.
          </p>
...
`,y={dialogue:[{delay:1e3,text:`Did you check what happens when you take the first word...`},{delay:3500,text:`...of every heading?`},{delay:7500,text:`Well, there is more...`}],hero:{title:`"Attention is All You Need."`,citation:`— Vaswani et al., 2017`},intro:`There is a philosophy behind the design of the home page, which I can guarantee that you missed. You can say they are Easter eggs, and to catch them, attention is all you need.

Here is everything that you missed.`,sections:[{num:`1`,title:`The Double Entendre`,body:`The title of this page, "Attention is All You Need," is the title of the landmark 2017 research paper that birthed the Transformer architecture, fundamentally changing the trajectory of Artificial Intelligence. But here, it serves a dual purpose. It is a technical nod to the field I engineer in, and a literal directive to you, the observer.`},{num:`2`,title:`The B.A.T.T.L.E. Acronym`,body:`If you scroll through the home page, the primary headers follow a strict sequence:
...
Every innovation is a **BATTLE**. And what is at the end of every battle? The final section: **EXCELLENCE**.`},{num:`3`,title:`The Solarpunk Synthesis (Hans Zimmer & The Plants)`,body:`Why the massive Aloe and Mint leaves intersecting with rigid, high-entropy mathematical canvas engines? The aesthetic is deeply inspired by the musical philosophy of Hans Zimmer. Zimmer creates monumental scores (like *Interstellar* or *Dune*) by colliding cold, synthetic, electronic synthesizers with raw, primal, organic instruments.

This portfolio operates on that same frequency. The computational physics, the 1-bit weight quantization, the cellular automata—that is the synthetic engine. The organic plants framing the black-and-white portrait represent the human element. It is Solarpunk in its purest form: high-computation harmonizing with raw nature. The machine is dead without the observer.`}],footer:{arxivUrl:`https://arxiv.org/abs/1706.03762`}},b=y.sections.map(e=>{let t=e.body.replace(/\*\*([^*]+)\*\*/g,`<strong>$1</strong>`).replace(/\*([^*]+)\*/g,`<em>$1</em>`).replace(/\n/g,`<br>`);return`
